...
# def checkAvailability(token, date):
#     url_check = "https://ndyy.ncu.edu.cn/api/badminton/getReservationInformation"
#     params = {
#         "role": "ROLE_STUDENT",
#         "date": date
#     }
...
#     # 首先检查场地可用性
#     check_response = checkAvailability(token, date)
#     if check_response.status_code == 200:
#         check_result = check_response.json()
#         print(f"场地查询结果: {check_result}")
#         # 如果场地不可用，直接返回
